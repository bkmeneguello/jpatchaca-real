...
chmod +x jpatchaca-real.sh
tee jpatchaca-real.desktop <<-EOF
#!/usr/bin/env xdg-open

[Desktop Entry]
Type=Application
Name=JPatchaca Real
Comment=Jira Front-end
Icon="$BASE/icon.png"
Exec="$BASE/jpatchaca-real.sh"
Terminal=false
Categories=Network
EOF

chmod +x jpatchaca-real.desktop

cp jpatchaca-real.desktop "$HOME/.local/share/applications/"
